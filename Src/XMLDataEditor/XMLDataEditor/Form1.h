...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->NodeList_comboBox->Location = System::Drawing::Point(65, 24);
			...
			this->toUTF32ToolStripMenuItem->Size = System::Drawing::Size(121, 22);
			...
			this->xmlParserToolStripMenuItem->Size = System::Drawing::Size(70, 20);
			...
			this->toBinaryFileToolStripMenuItem->Size = System::Drawing::Size(84, 20);
			this->toBinaryFileToolStripMenuItem->Text = L"ToBinaryFile";
			...
			// TextTreeMenuStrip
			// 
			this->TextTreeMenuStrip->Items->AddRange(gcnew cli::array< System::Windows::Forms::ToolStripItem^  >(8) {this->AddGroupToolStripMenuItem, 
			...
			this->TextTreeMenuStrip->Size = System::Drawing::Size(188, 180);
			// 
			...
			this->toNodeListToolStripMenuItem->Size = System::Drawing::Size(187, 22);
			...
			this->CollpaseElement_checkBox->Location = System::Drawing::Point(448, 32);
			...
			this->Unicode_checkBox->Location = System::Drawing::Point(584, 34);
...
private: System::Void saveToolStripMenuItem_Click(System::Object^  sender, System::EventArgs^  e)
		 {
			 ...
			 if(sender == openToolStripMenuItem)
			 {
				 ...
				 if( !l_strFileName )
					 return;
				 GCFORM::TreeNode^l_pNode = DNCT::OpenXmlFileToNode(l_strFileName,this->Unicode_checkBox->Checked);
				 if( l_pNode )
				 {
...
private: System::Void MainNode_treeView_DragDrop(System::Object^  sender, System::Windows::Forms::DragEventArgs^  e)
		 {
			...
			{
				 GCFORM::TreeNode^l_pNode = DNCT::OpenXmlFileToNode(l_str,this->Unicode_checkBox->Checked);
				 if( l_pNode )
				 {
