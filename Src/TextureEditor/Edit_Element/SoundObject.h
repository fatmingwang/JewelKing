...
namespace FMCEditor{
	...
	/// <summary>
	/// Summary for SoundObject
	/// </summary>
	public ref class SoundObject : public System::Windows::Forms::UserControl
	{
	public:
		SoundObject(GCFORM::TabControl^e_ptabControl)
		{
			InitializeComponent();
...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->Sound_listBox->ItemHeight = 15;
			this->Sound_listBox->Location = System::Drawing::Point(21, 59);
			this->Sound_listBox->Margin = System::Windows::Forms::Padding(4, 4, 4, 4);
			this->Sound_listBox->Name = L"Sound_listBox";
			this->Sound_listBox->Size = System::Drawing::Size(257, 124);
			...
			this->menuStrip1->Size = System::Drawing::Size(1153, 24);
			...
			// AddSound_button
			// 
			this->AddSound_button->Location = System::Drawing::Point(21, 200);
			this->AddSound_button->Margin = System::Windows::Forms::Padding(4, 4, 4, 4);
			this->AddSound_button->Name = L"AddSound_button";
			this->AddSound_button->Size = System::Drawing::Size(81, 30);
			...
			// DelSound_button
			// 
			this->DelSound_button->Location = System::Drawing::Point(111, 200);
			this->DelSound_button->Margin = System::Windows::Forms::Padding(4, 4, 4, 4);
			this->DelSound_button->Name = L"DelSound_button";
			this->DelSound_button->Size = System::Drawing::Size(81, 30);
			...
			// PlaySound_button
			// 
			this->PlaySound_button->Location = System::Drawing::Point(308, 102);
			this->PlaySound_button->Margin = System::Windows::Forms::Padding(4, 4, 4, 4);
			this->PlaySound_button->Name = L"PlaySound_button";
			this->PlaySound_button->Size = System::Drawing::Size(111, 30);
			...
			this->SoundLoop_checkBox->Location = System::Drawing::Point(215, 210);
			this->SoundLoop_checkBox->Margin = System::Windows::Forms::Padding(4, 4, 4, 4);
			this->SoundLoop_checkBox->Name = L"SoundLoop_checkBox";
			this->SoundLoop_checkBox->Size = System::Drawing::Size(56, 19);
			...
			// StopSound_button
			// 
			this->StopSound_button->Location = System::Drawing::Point(308, 140);
			this->StopSound_button->Margin = System::Windows::Forms::Padding(4, 4, 4, 4);
			this->StopSound_button->Name = L"StopSound_button";
			this->StopSound_button->Size = System::Drawing::Size(111, 30);
			...
			// 
			this->Piority_numericUpDown->Location = System::Drawing::Point(308, 210);
			this->Piority_numericUpDown->Name = L"Piority_numericUpDown";
			this->Piority_numericUpDown->Size = System::Drawing::Size(120, 25);
			...
			this->label1->Location = System::Drawing::Point(305, 192);
			...
			this->Size = System::Drawing::Size(1153, 271);
				 ...
				 else
				 {
					...
					for each(String^l_strName in l_strNameList)
					{
						...
						if(!DNCT::CheckListContainStringAndAdd(this->Sound_listBox,l_strFileName))
						{
						  ...
						  bool	l_b = m_pSoundParser->AddStaticSound(l_strFileName);
