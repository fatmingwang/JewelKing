...
//extern std::wstring	g_strFreeGameTest;
...
namespace EngineTest
{
	...
	public:
		Form1(void)
		{
			...
			//
			m_pGameApp = new cEngineTestApp((HWND)splitContainer1->Panel2->Handle.ToPointer(),Vector2(960,640));
...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			// button1
			// 
			this->button1->Location = System::Drawing::Point(109, 177);
			this->button1->Name = L"button1";
			this->button1->Size = System::Drawing::Size(84, 24);
			this->button1->TabIndex = 1;
			this->button1->Text = L"FreeGameTest";
...
private: System::Void button1_Click(System::Object^  sender, System::EventArgs^  e)
		 {
//			 g_strFreeGameTest = DNCT::GcStringToWchar(textBox1->Text);
		 }
};
}