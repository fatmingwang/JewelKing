...
namespace FileManager {
	...
	private: System::Windows::Forms::ListBox^  AllDirectories_listBox;
...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->AllDirectories_listBox = (gcnew System::Windows::Forms::ListBox());
			...
			this->AllFiles_listBox->Margin = System::Windows::Forms::Padding(2, 2, 2, 2);
			...
			this->AllFiles_listBox->Size = System::Drawing::Size(351, 364);
			this->AllFiles_listBox->TabIndex = 1;
			// 
			// SearchKeyWord_textBox
			// 
			this->SearchKeyWord_textBox->Location = System::Drawing::Point(80, 2);
			this->SearchKeyWord_textBox->Margin = System::Windows::Forms::Padding(2, 2, 2, 2);
			...
			this->QuickSearchData_comboBox->Margin = System::Windows::Forms::Padding(2, 2, 2, 2);
			...
			this->Delete_button->Margin = System::Windows::Forms::Padding(2, 2, 2, 2);
			...
			this->SelectFolder_button->Margin = System::Windows::Forms::Padding(2, 2, 2, 2);
			...
			// 
			// AllDirectories_listBox
			// 
			this->AllDirectories_listBox->Dock = System::Windows::Forms::DockStyle::Fill;
			this->AllDirectories_listBox->FormattingEnabled = true;
			this->AllDirectories_listBox->ItemHeight = 12;
			this->AllDirectories_listBox->Location = System::Drawing::Point(0, 0);
			this->AllDirectories_listBox->Margin = System::Windows::Forms::Padding(2, 2, 2, 2);
			this->AllDirectories_listBox->Name = L"AllDirectories_listBox";
			this->AllDirectories_listBox->ScrollAlwaysVisible = true;
			this->AllDirectories_listBox->SelectionMode = System::Windows::Forms::SelectionMode::MultiExtended;
			this->AllDirectories_listBox->Size = System::Drawing::Size(385, 364);
			this->AllDirectories_listBox->TabIndex = 10;
			// 
			// splitContainer1
			// 
			...
			// 
			this->splitContainer1->Panel2->Controls->Add(this->AllDirectories_listBox);
			...
			this->ClientSize = System::Drawing::Size(770, 456);
...
private: System::Void SelectFolder_button_Click(System::Object^  sender, System::EventArgs^  e)
		 {
			 ...
			 {
				AllDirectories_listBox->Items->Clear();
				...
				for each(String^l_FileName in l_pDirectoryArrayList)
				{
					for each( String^l_strExtenName in l_strExtensionNameSplit )
					{
						if(l_FileName->Contains(l_strExtenName))
						{
							AllDirectories_listBox->Items->Add(l_FileName);
						}
					}
				}
				for( int i=0;i<AllFiles_listBox->Items->Count;++i )
					AllFiles_listBox->SelectedIndices->Add(i);
				for( int i=0;i<AllDirectories_listBox->Items->Count;++i )
					AllDirectories_listBox->SelectedIndices->Add(i);
			 }
		 }
