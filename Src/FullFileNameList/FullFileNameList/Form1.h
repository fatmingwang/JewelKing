...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			// 
			this->DirectorySelect_button->Location = System::Drawing::Point(363, 12);
			this->DirectorySelect_button->Name = L"DirectorySelect_button";
			this->DirectorySelect_button->Size = System::Drawing::Size(113, 25);
			...
			// 
			this->ExtensionName_textBox->Location = System::Drawing::Point(123, 27);
			this->ExtensionName_textBox->Name = L"ExtensionName_textBox";
			this->ExtensionName_textBox->Size = System::Drawing::Size(217, 25);
			this->ExtensionName_textBox->TabIndex = 1;
			// 
			// AllFileList_textBox
			// 
			this->AllFileList_textBox->Location = System::Drawing::Point(-1, 71);
			...
			this->AllFileList_textBox->Size = System::Drawing::Size(856, 453);
			this->AllFileList_textBox->TabIndex = 2;
			// 
			// StripDirectory_checkBox
			// 
			this->StripDirectory_checkBox->AutoSize = true;
			this->StripDirectory_checkBox->Location = System::Drawing::Point(541, 16);
			this->StripDirectory_checkBox->Name = L"StripDirectory_checkBox";
			this->StripDirectory_checkBox->Size = System::Drawing::Size(108, 19);
			...
			this->label1->Size = System::Drawing::Size(94, 30);
			this->label1->TabIndex = 4;
			this->label1->Text = L"extension name\r\n\',\' to seperate";
			// 
			// Current_button
			// 
			this->Current_button->Location = System::Drawing::Point(363, 43);
			this->Current_button->Name = L"Current_button";
			this->Current_button->Size = System::Drawing::Size(113, 25);
			...
			this->StripExtensionName_checkBox->Location = System::Drawing::Point(541, 46);
			this->StripExtensionName_checkBox->Name = L"StripExtensionName_checkBox";
			this->StripExtensionName_checkBox->Size = System::Drawing::Size(143, 19);
			...
			this->menuStrip1->Size = System::Drawing::Size(853, 26);
			...
			this->fontToolStripMenuItem->Size = System::Drawing::Size(49, 22);
			...
			this->ClientSize = System::Drawing::Size(853, 521);
