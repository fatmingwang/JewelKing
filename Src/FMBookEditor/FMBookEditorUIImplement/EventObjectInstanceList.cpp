...
namespace FMBookEditor
{
		...
		//		cEventObjectInstance*l_pEventObjectInstance = cFMBookApp::m_spEventPackageRunner->GetCurrentEventPackage()->GetObject(l_strName);
		...
		//		//cFMBookApp::m_spEventManager->GetCurrentPackage()->GetObjectm_EventObjectInstance_listBox->SelectedIndex
		//	}
		//}
		...
		System::Void cEventObjectInstance_Editor::Add(System::Object^  sender, System::EventArgs^  e)
		{
			...
			if( cFMBookApp::m_spEventPackageRunner->GetCurrentEventPackage()->GetObject(DNCT::GcStringToWchar(m_pEventObjectInstanceName->Text)) )
			...
			if(m_pEventObjectStatusName->Text->Length)
			{
				...
				l_pEventObjectStatus = cFMBookApp::m_spEventManager->m_pEventObjectStatusList->GetObject(l_strName);
			...
			if(m_pEventInstanceName->Text->Length)
			{
				...
				l_pEventInstance = cFMBookApp::m_spEventManager->GetEventInstance(l_strEventInstance);
				if( !l_pEventInstance )
				{
			...
			cFMBookApp::m_spEventPackageRunner->GetCurrentEventPackage()->AddObject(l_pEventObjectInstance);
