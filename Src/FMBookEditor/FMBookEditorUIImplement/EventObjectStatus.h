...
namespace FMBookEditor 
{
	...
	public:
		EventObjectStatus(FMBookEditorUI::FMBookUI^e_pUserControl1,cFatmingUtilitiesData^e_pFatmingUtilitiesData)
		{
			...
			this->m_pEventObjectStatus->m_ImagePosXYZNumeric->SetMinimim(-9999999.f);
			this->m_pEventObjectStatus->m_ImagePosXYZNumeric->SetMaximim(9999999.f);
			this->m_pEventObjectStatus->m_ImageSizeXYNumeric->SetMinimim(0.f);
			this->m_pEventObjectStatus->m_ImageSizeXYNumeric->SetMaximim(99999.f);
		}
	protected:
		~EventObjectStatus();
    //my
