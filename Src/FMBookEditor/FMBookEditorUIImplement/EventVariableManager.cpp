...
namespace FMBookEditor
{
	System::Void cEventVariableManager_Editor::Add(System::Object^  sender, System::EventArgs^  e)
	{
		...
		if( l_strName->Length && l_strValue->Length && l_iSelectedIndex!= -1 )
		{
			...
			cEventVariable*l_pEventVariable = cFMBookApp::m_spEventManager->m_pEventVariableManager->GetObject(l_strVariableName.c_str());
			if( l_pEventVariable )
			{
			...
			else
			{
				...
				cFMBookApp::m_spEventManager->m_pEventVariableManager->AddObject(l_pEventVariable);
	...
	System::Void cEventVariableManager_Editor::Del(System::Object^  sender, System::EventArgs^  e)
	{
		if( m_pEventVariableManager->m_EventVariable_listBox->SelectedIndex != -1 )
		{
			...
			cFMBookApp::m_spEventManager->m_pEventVariableManager->RemoveObject(m_pEventVariableManager->m_EventVariable_listBox->SelectedIndex);
	...
	System::Void cEventVariableManager_Editor::Revert(System::Object^  sender, System::EventArgs^  e)
	{
		if( m_pEventVariableManager->m_EventVariable_listBox->SelectedIndex != -1 )
		{
			cEventVariable*l_pEventVariable = cFMBookApp::m_spEventManager->m_pEventVariableManager->GetObject(m_pEventVariableManager->m_EventVariable_listBox->SelectedIndex);
	...
	void	cEventVariableManager_Editor::Refresh()
	{
		...
		int	l_iCount = cFMBookApp::m_spEventManager->m_pEventVariableManager->Count();
		for( int i=0;i<l_iCount;++i )
		{
			cEventVariable*l_pEventVariable = cFMBookApp::m_spEventManager->m_pEventVariableManager->GetObject(i);
