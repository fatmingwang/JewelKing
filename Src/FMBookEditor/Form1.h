...
namespace FMBookEditor 
{
	...
	public:
		Form1(void)
		{
			...
			m_pFMBookApp = new cFMBookApp((HWND)l_pWindowsFormsHost->Child->Handle.ToPointer());
			m_pFMBookApp->Init();
...
#pragma endregion
	private: System::Void timer1_Tick(System::Object^  sender, System::EventArgs^  e)
			 {				 
				...
				m_pFMBookApp->m_svViewPortSize.x = (float)l_pPanel->Width;
				m_pFMBookApp->m_svViewPortSize.y = (float)l_pPanel->Height;//(float)this->m_pFMBookUI->ActualHeight;
				m_pFMBookApp->Run();
			 }
