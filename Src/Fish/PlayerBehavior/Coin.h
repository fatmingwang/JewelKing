...
class cCoin:public cBaseBehavior
{
	...
	cMPDI*						m_pMPDI_BigWinShow3_D;
	cMPDI*						m_pMPDI_BigWinShow3_D_ScorePos;
	cMPDI*						m_pMPDI_BigWinShow3_U;
	cMPDI*						m_pMPDI_BigWinShow3_U_ScorePos;
