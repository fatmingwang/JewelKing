...
{
	//bullet go to trace this monster
...
private:
	...
	void					BulletTracingUpdate( float e_fElpaseTime );
	void					SetTransform();
...
public:
	...
	void			Fire(cPlayerBehaviorBase*e_pPlayer,Vector3 e_vStartPos,float e_fAngle,cMonster*e_pTargetMonster);
