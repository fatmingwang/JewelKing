...
#include "Mesh.h"
	...
	//================
	class	cColladaParser:public cNodeISAX
	{
	...
	public:
		...
		virtual	bool	ParseDataIntoXMLNode(char*e_strFileName,bool e_bStroeInfo = false);
		cObjectListByName<cMesh>	m_AllMesh;
		cObjectListByName<cAnimationMesh>*	m_pAllAnimationMesh;
