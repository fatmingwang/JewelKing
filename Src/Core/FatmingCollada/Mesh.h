...
class	sTechniqueAndTexture:public cSimpleGLTexture
{
	GET_SET_DEC(eTechniqueType,m_eTechniqueType,GetTechniqueType,SetTechniqueType);
public:
	sTechniqueAndTexture(cSimpleGLTexture*e_pSimpleGLTexture,eTechniqueType e_eTechniqueType):cSimpleGLTexture(e_pSimpleGLTexture)
	{
...
//=================
//class	cMesh:public Frame,public cObjectListByName<sTechniqueAndTexture>
//{
//
//	//
...
public:
	...
	void	ChangeDiffuseImage(cSimpleGLTexture*e_pSimpleGLTexture);

	class cTriangles:public cObjectListByName<sTechniqueAndTexture>
	{
		UINT	*m_puiIndexBuffer;
		cVBOBuffer*m_pVBOBuffer;
		int	m_iStartIndex;
