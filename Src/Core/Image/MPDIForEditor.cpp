...
namespace FATMING_CORE
{
	...
	cMPDIForEditor::cMPDIForEditor(cMultiPathDynamicImage*e_pMultiPathDynamicImage)
	:cMultiPathDynamicImage(e_pMultiPathDynamicImage)
	{
		memset(m_strForCollidedpiFile,0,sizeof(WCHAR)*MAX_PATH);
	...
	void	cMPDIForEditor::RenderWithImage()
	{
		...
		if( m_pBasemageForShow )
		{
			...
			l_Pos.x-=(m_pBasemageForShow->GetImageWidth()/2);
			l_Pos.y-=(m_pBasemageForShow->GetImageHeight()/2);
...
//	void	cMPDIForEditor::ProcessCurveData()
//	{
...
//	void	cMPDIForEditor::ProcessCurvePoint()
//	{
...
//	}
//	//<CurveTime   />
//	void	cMPDIForEditor::ProcessCurveTime()
//	{
//		assert(this->GetObject(this->Count()-1) && "data order is error" );
...
//		l_pCurvesWithTime->DoLOD();
//	}
//	void	cMPDIForEditor::HandleElementData(TiXmlElement*e_pTiXmlElement)
//	{
//		const WCHAR*	l_strForElementName = e_pTiXmlElement->Value();
...
//	}
//
//	void	cMPDIForEditor::PathMoviing(bool e_bClicked,POINT e_MousePos)
//	{
//		
//	}	
//
//	void	cMPDIForEditor::ProcessPIFileName()
//	{
//		swprintf(m_strForCollidedpiFile,MAX_PATH,L"%ls\0",this->m_pCurrentTiXmlElement->FirstAttribute()->Value());
//	}
//
//	void	cMPDIForEditor::ExportData(char*e_strFileName,char*e_strForCollidedpiFile,char*e_pstrAutorData)
//	{
//#ifdef WIN32
...
//			l_pXMLWriter->StartElement( "CurveData" );
//			l_pXMLWriter->AddAttribute("Name",UT::WcharToChar(l_pCurvesWithTime->GetName()));
//			int	l_iCount = l_TimeList.size();
