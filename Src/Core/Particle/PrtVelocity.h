...
namespace FATMING_CORE
{
	...
	public:
		...
		~cPrtVelocityActDircctionChange(){}
		virtual inline void	Update(float e_fElpaseTime,int e_iIndex,sParticleData*e_pParticleData)
		{
			...
			if( m_vStopTime.x != 0.f )
			{
				...
				{
					if( m_bAccesleration )
						e_pParticleData->vVelocity.x += (m_vNewSpeed.x*2);
					else
						e_pParticleData->vVelocity.x = m_vNewSpeed.x;
				}
			}
			...
			if( m_vStopTime.y != 0.f )
			{
				...
				{
					if( m_bAccesleration )
						e_pParticleData->vVelocity.y += (m_vNewSpeed.y*2);
					else
						e_pParticleData->vVelocity.y = m_vNewSpeed.y;
				}
			}
			if( m_vStopTime.z != 0.f )
			{
				...
				{
					if( m_bAccesleration )
						e_pParticleData->vVelocity.z += (m_vNewSpeed.z*2);
					else
						e_pParticleData->vVelocity.z = m_vNewSpeed.z;
				}
			}
		}
		//usage explanation
	...
	public :
		...
		~cPrtVelocityActBySatelliteAction(){}
		virtual inline void	Update(float e_fElpaseTime,int e_iIndex,sParticleData*e_pParticleData)
		{
		  //set pivot
