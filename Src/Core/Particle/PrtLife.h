...
namespace FATMING_CORE
{
	//===========================================
	//Life Init
	//it should have a infinity life circle
	//===========================================	
	...
	//	WCHAR	m_sParticleName[MAX_PATH];
	...
	//	WCHAR*	GetParticleName(){ return m_sParticleName; }
	//	void	SetParticleName(WCHAR*e_pName){ swprintf_s(m_sParticleName,MAX_PATH,L"%s\0",e_pName); }
	//	DEFINE_TYPE_INFO();
