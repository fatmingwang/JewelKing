...
namespace FATMING_CORE
{
	...
	class	cParticleEmiterWithShowPosition:public cFatmingAnimationRule//PRT::cPrtEmitter
	{
	...
	public:
		DEFINE_TYPE_INFO();
		cParticleEmiterWithShowPosition(WCHAR*e_strName);
		...
		~cParticleEmiterWithShowPosition();
		...
		Vector3*			GetPosPointer(){ return &this->m_vPos; }
