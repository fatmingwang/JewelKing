...
namespace FATMING_CORE
{
	...
	public :
		...
		~cPrtStartPositionInitBySquareRange(){}
	...
	class cPrtStartPositionInitByFrame:public cParticleBase
	{
		...
		WCHAR	m_psSubFrameName[MAX_PATH];
		//to get data from 
	...
	public :
		...
		WCHAR*	GetSubFrameName(){ return m_psSubFrameName; }
		void	SetSubFrameName(WCHAR*e_pString);
		//usage explanation
		static char*	UsageExplanation;
		//
		virtual NamedTypedObject*  Clone();
