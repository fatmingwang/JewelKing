...
namespace FATMING_CORE
{
	...
	class cQuickUpdateParticleObjectListByName:public cObjectListByName<cParticleBase>
	{
	...
	class cPrtEmitter:public NamedTypedObject
	{
	...
	public:
		DEFINE_TYPE_INFO();
		cPrtEmitter(const WCHAR*e_pName);
		...
		void	SetTexture(cSimpleGLTexture*e_pTexture);
		...
		void	SetLoop(bool e_bLoop){if( e_bLoop )m_iParticleEmitCount = 0;else m_iParticleEmitCount = 1;}
		bool	IsLoop(){ return m_iParticleEmitCount==0?true:false; }
	};
