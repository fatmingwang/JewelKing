...
namespace FATMING_CORE
{
	...
	class cPaticleManager:public cObjectListByName<cPrtEmitter>,public ISAXCallback
	{
	...
	public:
		...
		cPaticleManager();
		~cPaticleManager();
		cPrtEmitter*		GetEmitter(const char*e_strFileName,const WCHAR*e_strName);
	...
	class cBehaviorPaticleManager:public cObjectListByName<NamedTypedObject>,public ISAXCallback
	{
	...
	public:
		...
		cParticleEmitterGroup*  GetPRTG(const WCHAR*e_strName);
		cParticleEmitterGroup*  GetPRTG(const char*e_strFileName,const WCHAR*e_strName);
	};
	
	typedef cObjectListByName<cBehaviorPaticleManager>  cPrtGList;
