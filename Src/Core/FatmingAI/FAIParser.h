...
namespace FATMING_AI
{
    ...
    //</AI>
    //
    //class   cFAIMaintainMachine:public cObjectListByName<cFAIBaseBehave>
    ...
    public:
		cFAIBehaviorParser();
		~cFAIBehaviorParser();
		cObjectListByName<cFAICharacterStatus>		m_FAICharacterStatusList;
		cObjectListByName<cFAICharacterInterface>	m_FAICharacterInterfaceList;
		cObjectListByName<cFAIMachine>				m_FAIMachineList;
