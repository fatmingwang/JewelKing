...
#else//for iphone and linux,u have to set directory as correct as expect.
...
namespace FATMING_CORE
{
	...
	cbtConcaveShapeList::cbtConcaveShapeList(cbtConcaveShapeList*e_pbtConcaveShapeList):
		cObjectListByName<cbtShapeCollision>(e_pbtConcaveShapeList),cbtShapeCollision(e_pbtConcaveShapeList)
	{
	}
	...
	void	Test()
	{
		...
		//l_2DImageCollisionData->OpenFile("C:/Users/ShihMing/Desktop/�D��γ��ظI���d��/�D��γ��ظI���d��/10/10.xml");
