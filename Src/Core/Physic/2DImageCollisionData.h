...
//        <Shape Type="Circle" DataCount="1" Data="191.00,310.00,0.00," />
//    </CollisionData>
...
//</ImageCollisionData>
	...
	public:
		...
		struct	sImageCollisionData
		{
			...
			{
				//we mught need to drag the point,and this is what index is it(circle do not to consider this)
				int	iFocusPoint;
				...
				sCollisionData(){ pCircleData = 0; iFocusPoint = -1; }
				~sCollisionData(){ SAFE_DELETE(pCircleData); }
		...
		WCHAR	m_strForCollidedpiFile[MAX_PATH];
		//for editor use
		//0 for add 1 for fix
...
//
//=================================================
	class	c2DImageCollisionData:public ISAXCallback,public cObjectListByName<cbtConcaveShapeList>
	{
		//for temp store data
