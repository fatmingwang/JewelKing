...
{
	class cCurve:virtual public NamedTypedObject
	{
	...
	public:
		...
		void				RenderCurve(Vector4 e_vColor = Vector4::One,cMatrix44 e_mat = cMatrix44::Identity);
		//
	...
	//=====================
	class	cCurveWithTime:public cCurve
	{
	...
	public:
		...
		//compare to original time and reset by persentage
		...
		//fetch time list's last data,enusre the implement class has overrie it,or it will fetch the time by this
		float			GetLastTime();
