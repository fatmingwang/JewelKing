#ifndef _MULTI_PAGE_H_
#define _MULTI_PAGE_H_
#include "Tabpage.h"

namespace FATMING_CORE
{
	//it has a arrow to flip pages,whil turn pages is called new items will appear
	//the Objects of cClickMouseBehaviorList will change while page index is changed.
	...
	class	cMultiPages:public cTabPage
	{
		...
		cObjectListByName<cImageButton>	m_ImageButtonObjects;
		int	m_iTotalPages;
