...
//		
//============
	class	cLinkedNodes:public cObjectListByName<cLinkedNodes>
	{
		...
		bool			FindTargetNode(cLinkedNodes*e_pTarget,cObjectListByName<cLinkedNodes>*ParentPath,cObjectListByName<cObjectListByName<cLinkedNodes> >*e_pResultPathes,bool e_bFindShoest = false);
	public:
		...
		bool			FindTargetNode(cLinkedNodes*e_pTarget,cObjectListByName<cObjectListByName<cLinkedNodes> >*e_pResultPathes,bool e_bFindShoest = false);
	};
	...
	public:
		...
		bool	FindTargetNode(POINT e_Point1,
							   POINT e_Point2,
							   cObjectListByName<cObjectListByName<cLinkedNodes> >*e_pResultPathes,bool e_bFindShoest = false);
	};
	//sample
	//how to find way to go.
	//OutputDebugString(L"=====================\n");
	//cObjectListByName<cObjectListByName<cLinkedNodes>> l_ResultPathes;
	...
	//OutputDebugString(L"ResultCount:");
	//OutputDebugString(ValueToStringW(l_ResultPathes.Count()));
	//OutputDebugString(L"\n");
	//for(int	i = 0;i<l_ResultPathes.Count();++i)
	//{
	//	OutputDebugString(L"Path");
	//	OutputDebugString(ValueToStringW(i));
	//	OutputDebugString(L":");
	//	cObjectListByName<cLinkedNodes>*l_pPath = l_ResultPathes.GetObject(i);
	//	for(int	j = 0;j<l_pPath->Count();++j)
	//	{
	//		OutputDebugString(l_pPath->GetObject(j)->GetName());
	//		OutputDebugString(L" __ ");
	//	}
	//	OutputDebugString(L"\n");
	//}
	//
