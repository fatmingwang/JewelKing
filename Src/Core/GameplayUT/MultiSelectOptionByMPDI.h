...
//===========================
    ...
    public:
        ...
        ~cSelectOptionByCueToStartCurveWithTime();
    ...
    //========================
    //class   cMultiSelectOptionByMPDI:virtual public cSimplePhase,virtual public cClickMouseBehaviorList<cSelectOptionByCueToStartCurveWithTime>
