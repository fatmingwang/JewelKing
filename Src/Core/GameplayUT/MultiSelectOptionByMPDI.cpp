...
namespace FATMING_CORE
{
    ...
    cSelectOptionByCueToStartCurveWithTime::cSelectOptionByCueToStartCurveWithTime(cMPDIList*e_pMPDIList,int e_iIndex,WCHAR*e_strDescription)
    {
        if( e_strDescription )
            m_strDescription = e_strDescription;
        if( e_pMPDIList )
        {
            WCHAR*l_ppNameRule[] = {L"Idle",L"Horver",L"Selected"};
	...
	cSelectOptionByCueToStartCurveWithTime::cSelectOptionByCueToStartCurveWithTime(cCueToStartCurveWithTime*e_pIdel,cCueToStartCurveWithTime*e_pHorver,cCueToStartCurveWithTime*e_pSelect,WCHAR*e_strDescription)
	{
        if( e_strDescription )
            m_strDescription = e_strDescription;
    ...
    void    cSelectOptionByCueToStartCurveWithTime::Render()
    {
        ...
        if( m_strDescription.length() )
        {
            ...
            cGameApp::m_spGlyphFontRender->RenderFont(l_vPos.x,l_vPos.y,(WCHAR*)m_strDescription.c_str());
        }
    }
    ...
    void    cSelectOptionByCueToStartCurveWithTime::Update(float e_fElpaseTime)
    {
		...
		if(this->IsSatisfiedCondition()&&m_pDoButtonGoal_Callback)
		{
