...
namespace FATMING_CORE
{
	...
	public:
		...
		virtual	bool				SetValue(const WCHAR*e_strValue) = 0;
	...
	public:
		...
		bool	SetValue(T  e_Value,bool e_bForceToLimit = false){ return  ValueChangeVaild(m_Value,e_Value,e_bForceToLimit); }
		virtual	bool		SetValue(const WCHAR*e_strValue)
		{
			switch( m_eDataType )
			{
				case eDT_BYTE:
