...
namespace FATMING_CORE
{
	...
	cMouse_TouchWithCancelButton::cMouse_TouchWithCancelButton(cImageButton*e_pCancelButton,Vector4 e_vWorkingRectRange,bool e_bForceSetCancelButtonPositionbyWorkingZone)
	{
		m_bCheckOutOfWorking = true;
		m_pCancelButton = 0;
		m_bOutOfWorkingZone = false;
		if( e_pCancelButton )
		{
			...
			if( e_bForceSetCancelButtonPositionbyWorkingZone )
				m_pCancelButton->SetPosByImageCenter(Vector3(e_vWorkingRectRange.z,e_vWorkingRectRange.y,0.f));
		}
