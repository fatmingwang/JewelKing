...
{
	const wchar_t*         cEventAddEventObjectInstace::TypeID( L"cEventAddEventObjectInstace" );
	cEventAddEventObjectInstace::cEventAddEventObjectInstace(TiXmlElement*e_pTiXmlElement)
	{
		ELEMENT_VALUE_ASSERT_CHECK(e_pTiXmlElement,cEventAddEventObjectInstace::TypeID)
		PARSE_ELEMENT_START(e_pTiXmlElement)
			...
			{
				m_bAllEventObjectStatusWorking = VALUE_TO_BOLLEAN;
			}
			else
	...
	cEventAddEventObjectInstace::cEventAddEventObjectInstace(cEventAddEventObjectInstace*e_pEventAddEventObjectInstace)
	{
	...
	cEventAddEventObjectInstace::~cEventAddEventObjectInstace()
	{
	
	}

	void	cEventAddEventObjectInstace::InternalInit()
	{
	...
	void	cEventAddEventObjectInstace::InternalUpdate(float e_fElpasedTime)
	{
	...
	//<cEventAddEventObjectInstace cEventObjectInstance="" cEventInstance="" cEventObjectStatus="" cEventVariable="" AllStatusWorking="" />
	TiXmlElement*		cEventAddEventObjectInstace::ToTiXmlElement()
	{
