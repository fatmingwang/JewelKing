...
namespace FATMING_CORE
{
	...
	class   cEventManager:public cNodeISAX
    {
		...
		void											EventInstanceAssignEventList(TiXmlElement*e_pElement,cClickMouseBehaviorList<cEventBase>*e_pList,bool e_bTrigger);
    ...
    public:
		...
		cObjectListByName<cEventInstance>*				m_pEventInstanceList;
		cObjectListByName<cEventObjectStatus>*			m_pEventObjectStatusList;
		cObjectListByName<cExternalFunction>*			m_pExternalFunctionList;
		//for programming not xml
		cObjectListByName<cEventPackage>*				m_pExternalEventPackage;
		...
		cEventObjectStatus*								GetEventObjectStatus(TiXmlElement*e_pElement);
		cEventInstance*									GetEventInstance(TiXmlElement*e_pElement);
		...
		char*											GetFullpathFileName(const WCHAR*e_strName);
