...
namespace FATMING_CORE
{
	...
	public:
		...
		//
		bool	UpdateEventList(cObjectListByName<cEventBase>*e_EventList,float e_fElpasedTime);
		void	RenderEventList(cObjectListByName<cEventBase>*e_EventList);
 ...
 /*!
   ...
   */
	...
	*/
	//class	cEventInstanceOwner:public cObjectListByName<cEventInstance>
	//{
