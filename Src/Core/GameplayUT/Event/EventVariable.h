...
namespace FATMING_CORE
{
	...
	public:
		DEFINE_TYPE_INFO();
		cEventVariable();
		cEventVariable(WCHAR*e_strName,eDataType e_eDataType,const WCHAR*e_strValue);
    ...
    //</cEventVariableList/>
	//all cObjectListByName<cEventVariable>::m_pData come from cEventVariableList::m_pData,so we could call SetData.get data to access out goal.
	//data not allow wstring and string.
	//only support AddObject and RemoveObject
	class	cEventVariableList:public cObjectListByName<cEventVariable>
	{
		void*				m_pData;
		eDataType			m_eDataType;
	public:
    ...
    //<cEventVariableList Name="Player1Data" Type="void" Value="30" >
	   ...
	   // <cEventVariable Name="OutMoney" Type="int" Value="6" />
    //</cEventVariableList>
	class	cEventVariableManager:public cObjectListByName<cEventVariable>,public ISAXCallback
	{
