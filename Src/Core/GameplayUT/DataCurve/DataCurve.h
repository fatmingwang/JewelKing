...
namespace FATMING_CORE
{
	...
	class	cDataAndCurveListWithXMlSechma:public cObjectListByName<cDataAndCurve>
	{
		struct	sData
		{
			std::wstring	strName;
