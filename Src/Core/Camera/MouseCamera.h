...
namespace FATMING_CORE
{
	...
	class cCameraBehaveByMouseBehave
	{
		...
		float					m_fMoveSpeed;
	public:	
		cCameraBehaveByMouseBehave(cFrameCamera*e_pCamera){ m_pCamera = e_pCamera; m_fAngelX = 0.0f; m_fAngelY = 0.0f; m_fMoveSpeed = 1.f; /*m_bFirstClick = false;*/ }
		~cCameraBehaveByMouseBehave(){ m_pCamera = NULL; }
