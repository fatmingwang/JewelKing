...
static NSString* kAppId = @"249299855095155";
...
-(void)uploadPhoto2:(UIImage*)image
{
    UIImage *img  = image;
...
extern UIWindow *g_pWindow;
-(void)Exitbutton:(id)sender
{
    self.view.hidden = true;
 //   [self.view removeFromuperview];
   // this.view.hidden = true;
    //[g_pWindow deleteSubview:super.view];
}
