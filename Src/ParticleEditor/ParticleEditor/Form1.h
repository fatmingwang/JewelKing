...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->openToolStripMenuItem->Size = System::Drawing::Size(295, 22);
			...
			this->openParticleEmitterGroupToolStripMenuItem->Size = System::Drawing::Size(295, 22);
			...
			this->saveToolStripMenuItem->Size = System::Drawing::Size(295, 22);
			...
			this->saveParticleEmitterGroupToolStripMenuItem->Size = System::Drawing::Size(295, 22);
			...
			this->assignDefaultDataToolStripMenuItem->Size = System::Drawing::Size(103, 20);
			...
			this->backGroundToolStripMenuItem->Size = System::Drawing::Size(77, 20);
			...
			this->x1080ToolStripMenuItem->Size = System::Drawing::Size(126, 22);
			...
			this->x720ToolStripMenuItem->Size = System::Drawing::Size(126, 22);
			...
			this->x768ToolStripMenuItem->Size = System::Drawing::Size(126, 22);
			...
			this->x480ToolStripMenuItem->Size = System::Drawing::Size(126, 22);
			...
			this->x320ToolStripMenuItem->Size = System::Drawing::Size(126, 22);
			...
			this->cameraTypeToolStripMenuItem->Size = System::Drawing::Size(77, 20);
			...
			this->Orthgnal_ToolStripMenuItem->Size = System::Drawing::Size(122, 22);
			...
			this->Perspective_ToolStripMenuItem->Size = System::Drawing::Size(122, 22);
			...
			this->ParticlePolicyPlane_ToolStripMenuItem->Size = System::Drawing::Size(164, 22);
			...
			this->ParticleDataPlane_ToolStripMenuItem->Size = System::Drawing::Size(164, 22);
			...
			this->EmiterGroupPlane_ToolStripMenuItem->Size = System::Drawing::Size(164, 22);
			...
			this->assistanceToolStripMenuItem->Size = System::Drawing::Size(64, 20);
			...
			this->showLineToolStripMenuItem->Size = System::Drawing::Size(130, 22);
			...
			this->showFPSToolStripMenuItem->Size = System::Drawing::Size(130, 22);
			...
			this->showPlaneToolStripMenuItem->Size = System::Drawing::Size(130, 22);
			...
			this->showEmitterToolStripMenuItem->Size = System::Drawing::Size(130, 22);
...
private: System::Void AddTexture_button_Click(System::Object^  sender, System::EventArgs^  e)
		 {
			 ...
			 for each( String^l_strFileName in l_pFileNames )
			 {
				...
				{
					 cSimpleGLTexture*l_pSimpleGLTexture = new cSimpleGLTexture(DNCT::GcStringToChar(l_strFileName));
					 if(l_pSimpleGLTexture->GetImageIndex())
					 {
						g_pPaticleManager->GetImageParser()->AddObject(l_pSimpleGLTexture);
						Texture_treeView->Nodes->Add(String(l_pSimpleGLTexture->GetCharName()).ToString());
					 }
					 else
					 {
...
private: System::Void AddEmiter_button_Click(System::Object^  sender, System::EventArgs^  e)
		 {
			 ...
			 if(l_strFileName->Length)
			 {
				 ...
				 if( !l_pPrtEmitter->GetTexture() )
				 {
					 ...
					 {
						l_pPrtEmitter->SetTexture(dynamic_cast<cSimpleGLTexture*>(g_pPaticleManager->GetImageParser()->GetObject(DNCT::GcStringToWchar(Texture_treeView->SelectedNode->Text))));
					 }
				 }
...
private: System::Void DataInvert_button_Click(System::Object^  sender, System::EventArgs^  e)
		 {
			if( EmiteListr_listBox->SelectedIndex != -1 )
			{
				...
				InitPolicy_flowLayoutPanel->Controls->Add(gcnew PrtVelocityInitSetVelocity(&l_pPrtVelocityInitSetVelocity->GetVeolcity()->x,
				...
				for( int i=0;i<l_pPrtEmitter->GetInitPolicyParticleList()->Count();++i )
				{
				...
				for( int i=0;i<l_pPrtEmitter->GetActPolicyParticleList()->Count();++i )
				{
				...
				int	l_iSrcIndex = BlendingIndexToIndex(g_pPrtEmitter->GetSrcBlendingMode());
				int	l_iDestIndex = BlendingIndexToIndex(g_pPrtEmitter->GetDestBlendingMode());
				SrcBlending_listBox->SelectedIndex = l_iSrcIndex;
				DestBlending_listBox->SelectedIndex = l_iDestIndex;
				if( l_pPrtEmitter->GetTexture() )
				{
					if( l_pPrtEmitter->GetTexture()->Type() == cSimpleGLTexture::TypeID||
...
private: System::Void Texture_treeView_AfterSelect(System::Object^  sender, System::Windows::Forms::TreeViewEventArgs^  e)
		 {
			 if( Texture_treeView->SelectedNode )
			 {
 				 ...
 				 if( !Texture_treeView->SelectedNode->Parent )//simple gl texture
				 {
					 ...
					 g_pPrtEmitter->SetTexture(dynamic_cast<cSimpleGLTexture*>(g_pPaticleManager->GetImageParser()->GetObject(l_strTextureName)));
				 }
				 else//pi
				 {
