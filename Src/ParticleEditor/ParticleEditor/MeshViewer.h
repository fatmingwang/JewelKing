...
namespace ParticalEditor {
	...
	public:
		MeshViewer(System::Windows::Forms::TabControl^e_pTabControl )
		{
			...
			m_pAllMesh = new cObjectListByName<cMesh>;
			...
			//FATMING_CORE::CreateShader(L"MeshShader");
			FATMING_CORE::CreateShader(g_bMyMeshVSClientState,g_strMyMeshVS,g_strMyMeshFS,L"StaticMeshShader");
			FATMING_CORE::CreateShader(g_bMySkinningMeshVSClientState,g_strMySkinningMeshVS,g_strMySkinningMeshFS,L"SkinningMeshShader");
			FATMING_CORE::CreateShader(g_bCommonVSNoTextureClientState,L"MeshShader_NoTexture");
			FATMING_CORE::CreateShader(g_bCommonVSClientState,L"MeshShader");
		}
	...
	protected:
		...
		~MeshViewer()
		{
			FATMING_CORE::DeleteShader(L"StaticMeshShader");			
			FATMING_CORE::DeleteShader(L"SkinningMeshShader");
			FATMING_CORE::DeleteShader(L"MeshShader_NoTexture");
			FATMING_CORE::DeleteShader(L"MeshShader");
	...
	//my
			...
			HGLRC	m_pHGLRCMV;
			HDC		m_HdcMV;
			cObjectListByName<cMesh>*	m_pAllMesh;
...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->JointName_label->Location = System::Drawing::Point(17, 197);
			...
			// 
			this->SpecificJointAnimation_numericUpDown->Location = System::Drawing::Point(20, 174);
			...
			this->SpecificJointAnimation_checkBox->Location = System::Drawing::Point(20, 154);
			...
			this->menuStrip1->Items->AddRange(gcnew cli::array< System::Windows::Forms::ToolStripItem^  >(2) {this->fileToolStripMenuItem, 
				this->invertTextureAdressToolStripMenuItem});
			...
			this->invertTextureAdressToolStripMenuItem->Size = System::Drawing::Size(123, 20);
			...
			this->trueToolStripMenuItem->Size = System::Drawing::Size(98, 22);
			...
			this->savePathFileToolStripMenuItem->Size = System::Drawing::Size(152, 22);
...
//=================================================
				...
				FATMING_CORE::UseShaderProgram(L"MeshShader_NoTexture");
				...
				if( m_pAllMesh->Count() )
				{
					FATMING_CORE::UseShaderProgram(L"StaticMeshShader");
					...
					{
						FATMING_CORE::UseShaderProgram(L"SkinningMeshShader");
						m_pFrameCamera->Render();
...
private: System::Void openToolStripMenuItem_Click(System::Object^  sender, System::EventArgs^  e)
		 {
			 ...
			 if( l_strFileName )
			 {
				 ...
				 m_pAllMesh->Destroy();
				 m_pColladaParser->m_AllMesh.DumpListPointer(m_pAllMesh);
				 m_pColladaParser->m_AllMesh.Destroy();
...
private: System::Void SpecificJointAnimation_numericUpDown_ValueChanged(System::Object^  sender, System::EventArgs^  e)
		 {
			 if(m_pColladaParser&&m_pColladaParser->m_pAllAnimationMesh&&m_pColladaParser->m_pAllAnimationMesh->Count())
			 {
				...
				String(MatrixToStringWithIndex(l_matW)).ToString()+DNCT::GetChanglineString()+
				String(MatrixToStringWithIndex(l_WorldTransform)).ToString();
			 }
		 }
